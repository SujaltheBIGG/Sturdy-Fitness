...
import { MAX_SERVINGS, fetchMealMedia, scaleQty } from '@sturdy/core/lib/recipe-media'
import type { MealMedia } from '@sturdy/core/lib/recipe-media'
import type { Recipe } from '@sturdy/core/types'
