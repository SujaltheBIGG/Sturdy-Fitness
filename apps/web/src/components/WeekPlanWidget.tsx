...
import { localDay, todayStr, addDays } from '@sturdy/core/lib/dateUtils'
import { CARDIO_ACTIVITY } from '@sturdy/core/lib/style-tokens'
import { WEEK_DAYS as FALLBACK_WEEK_DAYS } from '@sturdy/core/data/workouts'
import type { WeekDay } from '@sturdy/core/types'
