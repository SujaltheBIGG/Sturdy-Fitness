...
import type { EditorDay, EditorPhase } from '@sturdy/core/hooks/useProgramEditor'
import { copyDayTargets, copyPhaseTargets } from '@sturdy/core/hooks/useProgramEditor'
