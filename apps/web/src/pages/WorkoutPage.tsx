...
import { WEEK_DAYS as FALLBACK_WEEK_DAYS, PHASES as FALLBACK_PHASES, getWorkout as fallbackGetWorkout } from '@sturdy/core/data/workouts'
...
import { DAY_BY_INDEX, pickTrainingDay, nextTrainingDay } from '@sturdy/core/lib/training-day'
import { useAuthState } from '../contexts/AuthContext'
import { calculateWorkoutDuration } from '@sturdy/core/lib/duration'
import { plannedSetCount, trackWorkoutDayViewed } from '@sturdy/core/lib/session-funnel'
...
import { DAY_TYPE_COLORS, CARDIO_ACTIVITY } from '@sturdy/core/lib/style-tokens'
import type { Phase, WeekDay, DayId, DayType, Workout, ExerciseLog, SetData, CardioDayConfig, CircuitDefinition } from '@sturdy/core/types'
