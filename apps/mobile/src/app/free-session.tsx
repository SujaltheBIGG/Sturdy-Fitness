...
import { useFreeSessionTemplates } from '@sturdy/core/hooks/useFreeSessionTemplates'
import { localize } from '@sturdy/core/lib/i18n-db'
import type { CircuitDefinition, Exercise, FreeSessionTemplate } from '@sturdy/core/types'
...
export default function FreeSessionScreen() {
  ...
  const { templates, applyTemplate, deleteTemplate } = useFreeSessionTemplates(authUser?.id ?? null)
