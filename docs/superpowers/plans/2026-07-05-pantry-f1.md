...
```bash
git -C /Users/guillermomarin/Documents/ejercicios/sturdy-app checkout -b feat/pantry-f1
```
...
```bash
cd /Users/guillermomarin/Documents/ejercicios/sturdy-app && ./pocketbase migrate up
```
...
```bash
cd /Users/guillermomarin/Documents/ejercicios/sturdy-app && ./pocketbase serve   # :8090
...
No hay registro/barrel: los subpaths se importan directo (`@sturdy/core/hooks/usePantry`).
...
import { groupPantryByCategory } from '@sturdy/core/lib/pantry'
...
import type { PantryItem, PantryParsedItem, PantryParseResult } from '@sturdy/core/types'
...
```bash
pnpm --filter @sturdy/mobile typecheck
pnpm --filter @sturdy/mobile lint
```
